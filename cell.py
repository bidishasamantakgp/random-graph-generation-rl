...
class VAEGCell(object):
    ...
    def __init__(self, adj, weight, features, z_dim, bin_dim, node_count, edges):
        '''
        Args:
    ...
    def __call__(self,c_x,n,d,k,combination,eps_passed, sample,scope=None):
        ...
        return (c_x,enc_mu, enc_sigma, debug_sigma, dec_hidden, prior_mu, prior_sigma, z, weight, label, tf.reduce_mean(lambda_node), tf.reduce_mean(lambda_edge))
